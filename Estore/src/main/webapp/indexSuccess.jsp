            		...
            		<c:forEach items="${ map}" var="entry">
            			<dd>            		
                    		...
                    		<c:forEach items="${entry.value }" var="value1" >
		                        	...
		                        	<a href="list.html">${value1.name}</a>
                ...
                <div class="c3_b1_c_bottom">
                    <ul>
                    	<c:forEach items="${book }"  var="book1">
                    		<li>
                    		 	<a href="Servlet1"><img src="${book1.img }" height="150" width="200"/></a>
	                          	<a href="Servlet1?price=${book1.price }&id=${book1.id }&name=${book1.name }&img=${book1.img}">${book1.name }</a>                  
                       		</li>
                    	</c:forEach>
                        <!-- <li>
