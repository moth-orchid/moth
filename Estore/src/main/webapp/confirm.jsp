...
<body>
    ...
    <div class="content">
	    	<div class="contentCenter">
	    		...
	    		<span>
	    		<a href="confirmList.html"><button>删除该订单</button></a>   
	    		<a href="shopCart.jsp"><button>返回购物车修改</button></a>
	    		
	    		</span></p>
	    		<div class="bigDiv">
	    			<table border="1px solid red" >
	    			<c:forEach items="${list3 }" var="order">
	    				<tr>
	    					<td width="100px" ><img src="${order.img }" width="100px" height="100px"></td>
	    					<td width="300px" align="center" >${order.name}</td>
	    					<td width="600px" align="center" >${order.price}</td>
	    					<td width="100px" align="center" >${order.sellnum}件</td>
	    		...
	    		<!-- <div class="submit"> -->
	    		<div >
	    			<%-- <a href="Servet6?sum=${sumprice}"><span><a>应付金额：<font>${sumprice}</font> <button onclick="document.forms.conSuccess.submit()"><img alt="" src="images/21_03.png">  提交</button></a></span> --%>
	    			应付金额：<font>${sumprice}</font><a href="servlet6?sum=${sumprice}" value="提交订单" style="margin-left: 1000px">提交</a>
	    		</div>
	    	</div>
